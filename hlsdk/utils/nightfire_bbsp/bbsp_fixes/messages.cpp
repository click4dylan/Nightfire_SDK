...
static const MessageTable_t assumes[assume_last] = {
    ...
    {"Exceeded MAX_MAP_BRUSHES", "The maximum number of brushes for a map has been reached", selfexplanitory}, //these swapped around
    {"Exceeded MAX_MAP_SIDES", internallimit, contact}, //these swapped around
    ...
    {"Exceeded MAX_MAP_INDICES", internallimit, contact}, //new
    ...
    {"Exceeded MAX_MAP_MARKBRUSHES", internallimit, contact}, //new
