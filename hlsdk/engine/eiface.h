...
typedef struct
	...
	int		msg_entity; //added in nightfire, dylan
	} TraceResult;
...
{
	ConsoleVariable* (*pfnCreateConsoleVariableGame) (IConsoleVariable pCvar);
	qboolean	(*pfnDestroyConsoleVariableGame)  (IConsoleVariable*pCvar);
	ConsoleVariable* (*pfnGetConsoleVariableGame) (const char *szVarName);
	void		(*pfnRegisterGame)			(IConsoleFunction* pFunction);
	void		(*pfnUnregisterGame)		(IConsoleFunction* pFunction);
	...
	edict_t*	(*pfnFindEntityInSphere)	(edict_t *pEdictStartSearchAfter, const Vector &org, float rad);
	...
	int			(*pfnCheckBottom)			(edict_t *pEdict); //added
	int			(*pfnDropToFloor)			(edict_t* e);
	int			(*pfnWalkMove)				(edict_t *ent, float yaw, float dist, int iMode);
	void		(*pfnSetOrigin)				(edict_t *e, const float *rgflOrigin);
	void		(*pfnEmitSound)				(edict_t *entity, int channel, const char *sample, /*int*/float volume, float attenuation, int fFlags, int pitch);
	void		(*pfnEmitAmbientSound)		(edict_t *entity, float *pos, const char *samp, float vol, float attenuation, int fFlags, int pitch);
	void		(*pfnTraceLine)				(const float *v1, const float *v2, int fNoMonsters, int brushflags, edict_t *pentToSkip, TraceResult *ptr);
	void		(*pfnTraceToss)				(edict_t* pent, edict_t* pentToIgnore, TraceResult *ptr);
	int			(*pfnTraceCharacterHull)	(edict_t *pEdict, const float *v1, const float *v2, int fNoMonsters, edict_t *pentToSkip, TraceResult *ptr);
	void		(*pfnTraceHull)				(const float *v1, const float *v2, int fNoMonsters, int hullNumber, int brushflags, edict_t *pentToSkip, TraceResult *ptr);
	void		(*pfnTraceModel)			(const float *v1, const float *v2, int hullNumber, int brushflags, edict_t *pent, TraceResult *ptr);
...
typedef struct 
{
	...
	BOOLEAN(*pfnBlocked)					( edict_t *pentBlocked, edict_t *pentOther );
	void			(*pfnKeyValue)			( edict_t *pentKeyvalue, KeyValueData *pkvd );
	void			(*pfnSave)				( edict_t *pent, SAVERESTOREDATA *pSaveData );
	int 			(*pfnRestore)			( edict_t *pent, SAVERESTOREDATA *pSaveData, int globalEntity );
	void			(*pfnSetAbsBox)			( edict_t *pent );
	BOOLEAN			(*pfnBlockedTest)  ( edict_t* pentBlocked, edict_t* pentOther );
	...
	void			(*pfnClientCommand)		( edict_t *pEntity, unsigned int numargs, const char **args );
