...
struct PlayerInfo {
	...
	edict_t *pCameraEdict;
	edict_t *pSpectateTargetEdict;
	edict_t *pSpectateLastTargetEdict;
	int iSpectateMode;
	bool bSpectating;
	float flLastSpectateButtonPress;
	float flNextSpectateUpdate;
	Vector vecOriginBeforeSpectating;
	int iLastTeam;
	bool bCodeEnabledSpectator;
};
