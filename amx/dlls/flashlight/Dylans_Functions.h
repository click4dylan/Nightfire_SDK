...
//===== NETWORK ============
	...
	short interp_msec; //this is actually unknown in reality, but nothing seems to write to it, so we are using it for client's ex_interp value in ms
...
public:
	char * editabletext; // For functions with strtok()
