...
void OnPluginsLoaded()
{
	...
	g_pFunctionTable->pfnKeyValue=NULL;//KeyValue;
	...
	g_pFunctionTable->pfnClientCommand=NULL;//ClientCommand;

	g_pFunctionTable->pfnClientUserInfoChanged=NULL;//ClientUserInfoChanged;
