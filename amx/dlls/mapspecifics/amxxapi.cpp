...
void ClientDisconnect(edict_t *pEntity)
{
	...
	if ( plinfo[id].bConnecting ) {
		glinfo.iPlayersConnecting--;
		plinfo[id].bConnecting = false;
	}
...
BOOLEAN ClientConnect(edict_t *pEntity, const char *pszName, const char *pszAddress, char szRejectReason[128])
{
	...
	plinfo[id].bConnecting = true;
	glinfo.iPlayersConnecting++;
	glinfo.flNextMapSpecificsThinkTime = gpGlobals->time;
...
void ServerDeactivate()
{
	...
	glinfo.flNextMapSpecificsThinkTime = 0;
