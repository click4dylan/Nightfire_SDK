...
typedef BOOLEAN (*FN_GETBONECOORD)		(edict_t *ed, const char *bone, int unknown, int unknown2);
...
typedef void (*FN_PARTICLEEFFECT) (const float *org, const float *dir, float r, float g, float b, float count);
