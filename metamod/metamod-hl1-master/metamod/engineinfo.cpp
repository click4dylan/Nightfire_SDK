...
// on Win64.
const unsigned long c_VacDllEngineFuncsRangeMask  = 0xFF000000;
const unsigned long c_VacDllEngineFuncsRangeMark  = 0x01D00000;
void* const c_VacDllEngineFuncsRangeStart = (void*)0x43000000;
void* const c_VacDllEngineFuncsRangeEnd   = (void*)0x45000000;
...
int EngineInfo::nthdr_module_name( void )
{
	...
	const char* pName = "engine.dll"; //"sw.dll";
	/*
