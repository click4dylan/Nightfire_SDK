...
//LINK_ENTITY_TO_GAME(env_fog); //causes FindEntityInSphere to break in nightfire. this is a client only entity
...
LINK_ENTITY_TO_GAME(ambient_lightning);
LINK_ENTITY_TO_GAME(ammo_bondmine);
LINK_ENTITY_TO_GAME(ammo_commando);
LINK_ENTITY_TO_GAME(ammo_darts);
LINK_ENTITY_TO_GAME(ammo_flashgrenade);
LINK_ENTITY_TO_GAME(ammo_fraggrenade);
LINK_ENTITY_TO_GAME(ammo_grenadelauncher);
LINK_ENTITY_TO_GAME(ammo_kowloon);
LINK_ENTITY_TO_GAME(ammo_mini);
LINK_ENTITY_TO_GAME(ammo_mp9);
LINK_ENTITY_TO_GAME(ammo_pdw90);
LINK_ENTITY_TO_GAME(ammo_pp9);
LINK_ENTITY_TO_GAME(ammo_raptor);
LINK_ENTITY_TO_GAME(ammo_shotgun);
LINK_ENTITY_TO_GAME(ammo_smokegrenade);
LINK_ENTITY_TO_GAME(ammo_up11);
LINK_ENTITY_TO_GAME(character_bondmine);
LINK_ENTITY_TO_GAME(character_cine2_hvyweapons);
LINK_ENTITY_TO_GAME(character_cine2_scientist);
LINK_ENTITY_TO_GAME(character_cine2_slave);
LINK_ENTITY_TO_GAME(character_cine3_barney);
LINK_ENTITY_TO_GAME(character_cine3_scientist);
LINK_ENTITY_TO_GAME(character_cine_barney);
LINK_ENTITY_TO_GAME(character_cine_panther);
LINK_ENTITY_TO_GAME(character_cine_scientist);
LINK_ENTITY_TO_GAME(character_hevsuit_dead);
LINK_ENTITY_TO_GAME(character_mortar);
LINK_ENTITY_TO_GAME(charactermaker);
LINK_ENTITY_TO_GAME(ctf_hudicon);
LINK_ENTITY_TO_GAME(dart_tip);
LINK_ENTITY_TO_GAME(deadsnowguard);
LINK_ENTITY_TO_GAME(dumb_rocket);
LINK_ENTITY_TO_GAME(ei_grenade);
LINK_ENTITY_TO_GAME(enemy_attackcopter);
LINK_ENTITY_TO_GAME(enemy_drake);
LINK_ENTITY_TO_GAME(enemy_generic);
LINK_ENTITY_TO_GAME(enemy_helicopter);
LINK_ENTITY_TO_GAME(enemy_miniturret);
LINK_ENTITY_TO_GAME(enemy_ninja);
LINK_ENTITY_TO_GAME(enemy_pathvan);
LINK_ENTITY_TO_GAME(enemy_rocket);
LINK_ENTITY_TO_GAME(enemy_ronin_turret);
LINK_ENTITY_TO_GAME(enemy_rook_boss);
LINK_ENTITY_TO_GAME(enemy_scubasteve);
LINK_ENTITY_TO_GAME(enemy_searchlight);
LINK_ENTITY_TO_GAME(enemy_searchlight_target);
LINK_ENTITY_TO_GAME(enemy_sentry);
LINK_ENTITY_TO_GAME(enemy_turret);
LINK_ENTITY_TO_GAME(enemy_videocamera);
LINK_ENTITY_TO_GAME(enemy_videocamera_target);
LINK_ENTITY_TO_GAME(entity_light);
LINK_ENTITY_TO_GAME(env_deathcamera);
LINK_ENTITY_TO_GAME(env_drawwater);
LINK_ENTITY_TO_GAME(env_scoring);
LINK_ENTITY_TO_GAME(env_virtualexplosion);
LINK_ENTITY_TO_GAME(flash_grenade);
LINK_ENTITY_TO_GAME(func_balancebeam);
LINK_ENTITY_TO_GAME(func_characterclip);
LINK_ENTITY_TO_GAME(func_climbable);
LINK_ENTITY_TO_GAME(func_handoverhand);
LINK_ENTITY_TO_GAME(func_huggable);
LINK_ENTITY_TO_GAME(func_ledgehang);
LINK_ENTITY_TO_GAME(func_modeltrainclip);
LINK_ENTITY_TO_GAME(func_pathtruck_clip);
LINK_ENTITY_TO_GAME(func_pathvehicle_clip);
LINK_ENTITY_TO_GAME(func_ropeclimb);
LINK_ENTITY_TO_GAME(gadget_nightvision);
LINK_ENTITY_TO_GAME(guard_rocket);
LINK_ENTITY_TO_GAME(info_aievent);
LINK_ENTITY_TO_GAME(info_camera_node);
LINK_ENTITY_TO_GAME(info_camera_viewnode);
LINK_ENTITY_TO_GAME(info_characterguntarget);
LINK_ENTITY_TO_GAME(info_drive_target);
LINK_ENTITY_TO_GAME(info_picture_target);
LINK_ENTITY_TO_GAME(info_rain);
LINK_ENTITY_TO_GAME(info_snow);
LINK_ENTITY_TO_GAME(item_armor_plate);
LINK_ENTITY_TO_GAME(item_armor_vest);
LINK_ENTITY_TO_GAME(item_breakable);
LINK_ENTITY_TO_GAME(item_ctfportablebattery);
LINK_ENTITY_TO_GAME(item_ctfspeed);
LINK_ENTITY_TO_GAME(item_drivetarget);
LINK_ENTITY_TO_GAME(item_explosive);
LINK_ENTITY_TO_GAME(item_explosive_planted);
LINK_ENTITY_TO_GAME(item_genericfalling);
LINK_ENTITY_TO_GAME(item_grappletarget);
LINK_ENTITY_TO_GAME(item_key);
LINK_ENTITY_TO_GAME(item_lasertarget);
LINK_ENTITY_TO_GAME(item_locktarget);
LINK_ENTITY_TO_GAME(item_model_follow);
LINK_ENTITY_TO_GAME(item_padlock);
LINK_ENTITY_TO_GAME(item_scubasuit);
LINK_ENTITY_TO_GAME(item_space_suit);
LINK_ENTITY_TO_GAME(james_bond_test);
LINK_ENTITY_TO_GAME(laser_beam);
LINK_ENTITY_TO_GAME(monster_koi);
LINK_ENTITY_TO_GAME(multi_kill_manager);
LINK_ENTITY_TO_GAME(npc_aigeneric);
LINK_ENTITY_TO_GAME(npc_bird);
LINK_ENTITY_TO_GAME(npc_bird_flock);
LINK_ENTITY_TO_GAME(npc_generic);
LINK_ENTITY_TO_GAME(npc_koi);
LINK_ENTITY_TO_GAME(npc_modeltrain);
LINK_ENTITY_TO_GAME(npc_pathgeneric);
LINK_ENTITY_TO_GAME(npc_pathtruck);
LINK_ENTITY_TO_GAME(npc_pathvehicle);
LINK_ENTITY_TO_GAME(particle_emitter);
LINK_ENTITY_TO_GAME(physics_lantern);
LINK_ENTITY_TO_GAME(smart_rocket);
LINK_ENTITY_TO_GAME(smoke_grenade);
LINK_ENTITY_TO_GAME(trigger_acfiremissile);
LINK_ENTITY_TO_GAME(trigger_bit);
LINK_ENTITY_TO_GAME(trigger_bit_counter);
LINK_ENTITY_TO_GAME(trigger_bondmoment);
LINK_ENTITY_TO_GAME(trigger_bondsecret);
LINK_ENTITY_TO_GAME(trigger_changecharacter);
LINK_ENTITY_TO_GAME(trigger_changelevelicon);
LINK_ENTITY_TO_GAME(trigger_changesequence);
LINK_ENTITY_TO_GAME(trigger_ctfscore);
LINK_ENTITY_TO_GAME(trigger_eject);
LINK_ENTITY_TO_GAME(trigger_endcinematic);
LINK_ENTITY_TO_GAME(trigger_endgame);
LINK_ENTITY_TO_GAME(trigger_hudmessage);
LINK_ENTITY_TO_GAME(trigger_objective);
LINK_ENTITY_TO_GAME(trigger_pathcamera);
LINK_ENTITY_TO_GAME(trigger_playmovie);
LINK_ENTITY_TO_GAME(trigger_sneak);
LINK_ENTITY_TO_GAME(trigger_to_first);
LINK_ENTITY_TO_GAME(trigger_togglehud);
LINK_ENTITY_TO_GAME(up11_dart);
LINK_ENTITY_TO_GAME(virtual_enemy_snowguard);
LINK_ENTITY_TO_GAME(virtual_npc_zoe);
LINK_ENTITY_TO_GAME(weapon_bondmine);
LINK_ENTITY_TO_GAME(weapon_commando);
LINK_ENTITY_TO_GAME(weapon_dukes);
LINK_ENTITY_TO_GAME(weapon_flashgrenade);
LINK_ENTITY_TO_GAME(weapon_frinesi);
LINK_ENTITY_TO_GAME(weapon_kowloon);
LINK_ENTITY_TO_GAME(weapon_l96a1);
LINK_ENTITY_TO_GAME(weapon_l96a1_winter);
LINK_ENTITY_TO_GAME(weapon_laserrifle);
LINK_ENTITY_TO_GAME(weapon_lighter);
LINK_ENTITY_TO_GAME(weapon_mp9);
LINK_ENTITY_TO_GAME(weapon_mp9_silenced);
LINK_ENTITY_TO_GAME(weapon_pda);
LINK_ENTITY_TO_GAME(weapon_pdw90);
LINK_ENTITY_TO_GAME(weapon_pen);
LINK_ENTITY_TO_GAME(weapon_pp9);
LINK_ENTITY_TO_GAME(weapon_qworm);
LINK_ENTITY_TO_GAME(weapon_raptor);
LINK_ENTITY_TO_GAME(weapon_ronin);
LINK_ENTITY_TO_GAME(weapon_taser);
LINK_ENTITY_TO_GAME(weapon_up11);
LINK_ENTITY_TO_GAME(weapon_watch);
LINK_ENTITY_TO_GAME(weaponbag);
LINK_ENTITY_TO_GAME(xrayskeleton);