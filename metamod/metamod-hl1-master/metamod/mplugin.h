...
#define SHOW_DEF_DLLAPI(api_table, pre_str, post_str) \
	...
	SHOW_IFDEF(api_table, dllapi_info, pfnBlockedTest, pre_str, post_str); \
...
#define SHOW_DEF_NEWAPI(api_table, pre_str, post_str) \
	...
	SHOW_IFDEF(api_table, newapi_info, pfnBot_GetParams, pre_str, post_str); \
	SHOW_IFDEF(api_table, newapi_info, pfnAddbot, pre_str, post_str);

#define SHOW_DEF_ENGINE(api_table, pre_str, post_str) \
	n=0; \
	SHOW_IFDEF(api_table, engine_info, pfnCreateConsoleVariableGame, 	pre_str, post_str); \
	SHOW_IFDEF(api_table, engine_info, pfnDestroyConsoleVariableGame, 	pre_str, post_str); \
	SHOW_IFDEF(api_table, engine_info, pfnGetConsoleVariableGame, 	pre_str, post_str); \
	SHOW_IFDEF(api_table, engine_info, pfnRegisterGame, 	pre_str, post_str); \
	SHOW_IFDEF(api_table, engine_info, pfnUnregisterGame, 	pre_str, post_str); \
	...
	SHOW_IFDEF(api_table, engine_info, pfnGetPointIllum, 		pre_str, post_str); \
	...
	SHOW_IFDEF(api_table, engine_info, pfnCheckBottom, 		pre_str, post_str); \
	...
	SHOW_IFDEF(api_table, engine_info, pfnTraceCharacterHull, 	pre_str, post_str); \
	...
	SHOW_IFDEF(api_table, engine_info, pfnAllocateDecal, 		pre_str, post_str); \
	...
	SHOW_IFDEF(api_table, engine_info, pfnWaterCheck, 	pre_str, post_str); \
	...
	SHOW_IFDEF(api_table, engine_info, pfnUnregUserMsgs, 	pre_str, post_str); \
	SHOW_IFDEF(api_table, engine_info, pfnGetBonePosition, 		pre_str, post_str); \
	SHOW_IFDEF(api_table, engine_info, pfnGetBoneCoord, 		pre_str, post_str); \
	...
	SHOW_IFDEF(api_table, engine_info, pfnCOM_Log, 	pre_str, post_str); \
	SHOW_IFDEF(api_table, engine_info, pfnCOM_FileBase, 	pre_str, post_str); \
	SHOW_IFDEF(api_table, engine_info, pfnCOM_LoadHeapFile, 	pre_str, post_str); \
	SHOW_IFDEF(api_table, engine_info, pfnCOM_ParseFile, 	pre_str, post_str); \
	SHOW_IFDEF(api_table, engine_info, pfnCOM_Token, 	pre_str, post_str); \
	SHOW_IFDEF(api_table, engine_info, pfnCOM_FreeFile, 		pre_str, post_str); \
